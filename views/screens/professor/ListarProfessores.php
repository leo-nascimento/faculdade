...
$v_professores = $v_params['v_professores'];
?>
<!DOCTYPE html>
<html>
<head>
...
<div  class="container-fluid" style="background-color: #23282e;">
    <div class="row">
        ...
        <div class="col-sm-offset-1">
            <h2 style="margin-left: 12px; color: #fff">Professores</h2>
        </div>
        <table class="table text-center" style="float: right; width: 75%; background-color: #fff">
            ...
            <tbody>
            <?php
            foreach($v_professores AS $o_professor) {
            ?>
            <tr style="font-size: small">
                <td><?php echo $o_professor->getNome()?></td>
                <td><?php echo $o_professor->getEmail()?></td>
                <td></td>
                <td>
                    <button type="button" class="btn btn-warning btn-sm" title="Editar dados"><i class="fa fa-edit"></i></button>
                    <button type="button" class="btn btn-danger btn-sm" title="Excluir aluno"><i class="fa fa-remove"></i></button>
                </td>
            </tr>
                <?php
            }
